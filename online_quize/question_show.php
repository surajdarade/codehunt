...
elseif($flag > 11)
        {
        echo '<script>swal("You Have Attempted Thie Certification Contact Admin For Retest")
        .then((value) => {
          document.location = "http://localhost:8080/CodeHunt/online_quize/quizhome.php";
        });;</script>';
