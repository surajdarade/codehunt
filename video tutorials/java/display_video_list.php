...
<center style="height: 50px; text-transform: uppercase; "><marquee><h1 class="text-black h3" style="color :RED;font-size:50px;" >Welcome To <?php echo $_GET['course_name']; ?> Video Tutorial</h1></marquee></center><br><br>
</div>
		<div class="row">
