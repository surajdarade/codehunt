...
mysqli_select_db($con,'projectdatabase');
    ...
    $course_name=$_GET['course_name'];
      $q="select * from videos where course_name='$course_name' AND username='admin'";
      //echo $course_name;
      ...
      <div class="inner">                                                  <!--  to zoom in and zoom out effect -->
          ...
          <div class="card-body shadow" style="background-color: #f1f1f1;">
           <!--  <h5 class="card-title"><?php echo $row['course_name']; ?></h5> -->
            ...
            <a href="video_add.php?id=<?php echo $row['video_id']?>&course_name=<?php echo $row['course_name'] ?>&video_name=<?php  echo $row['video_name']  ?>&run=delete" class="p-1 text-danger" name="delete_vid" style="text-decoration: none;">delete<i class="fa fa-trash-o ml-1"></i></a>
          </span>
          </div>
          </div>
