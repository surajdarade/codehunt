...
<head>
	...
	<link rel="stylesheet" type="text/css" href="dropdown.css">
	   ...
	   <!----favicon setting-->
	   <link rel="shortcut icon" type="text/css" href="uploads/logo/thinktank-high-resolution-logo-color-on-transparent-background.png">
...
<body>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li> <a href="#">Our Service</a>
				   <ul>
				     ...
				     <li> <a href="#">E-Tutorial</a></li>
					 <li> <a href="#">Exercise</a></li>
                   </ul>
				</li>
					<li> <a href="">Works</a>
					<ul>
				     <li> <a href="#">Enhancing Programming Skills</a></li>
				     <li> <a href="#">World Class Tutorials</a></li>
					 <li> <a href="#">Smart & Easy way of Learnning</a></li>
                   </ul></li>
					<li> <a href="">Team</a>
					<ul>
				     <li> <a href="#">Suraj Darade</a></li>
				     <li> <a href="#">Vishal Patil</a></li>
    ...
    <source src="langbackvid.mp4" type="video/mp4">
				...
				<div class="modal-dialog ">
					...
					<div class="modal-body" >
						...
						<form method="POST" action="validation.php" onsubmit="return validation()">
							...
							<div class="register">
								<h2>Don't have an account?&nbsp<span id="create-account"><a href="signup.html"><h5 style="color:red;">Create</h5></span></a> </h2>
							</div>
					...
					<div class="right-box">
						...
						<button class="social facebook"><i class="fa fa-facebook fa-2x"></i>Log in with Facebook</button>
						<button class="social twitter"><i class="fa fa-twitter fa-2x"></i>Log in with twitter</button>
						<button type="submit" class="social google" data-onsuccess="onSignIn()"><i class="fa fa-google fa-2x"></i>Log in with gmail</button>
					</div>
