...
.div1                           /* for title image*/
{
   ...
   position: relative;
    height: 500px;
    width: 1263px;
    background:url(img/prog_prog.jpg);
}
 					...
 					<div class="row">
 						<div class="col-xs-12">
 							<div class="section-title text-center">
 								<h2 style= "color:white"><b>PROGRAMMING LANGUAGES</b></h2>
        ...
        <div class="container">
          <div class="row row-30">
            <div class="col-md-4 col-xl-5">
              <div class="pr-xl-4"><a class="brand" href="index.html"><img class="brand-logo-light" src="uploads/logo/logo1.png" alt="" width="120" height="120" srcset="images/agency/logo-retina-inverse-280x74.png 2x"></a>
			</br>
			</br>
