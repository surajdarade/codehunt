...
<script>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navi">
				...
				<ul class="nav navbar-nav navbar-right">
					<li> <a href="/CodeHunt/index.php">Home</a></li>
					<li> <a href="/CodeHunt/index.php#myservice_section">Our Service</a></li>
					<li> <a href="/CodeHunt/index.php#work">Works</a></li>
					<li> <a href="/CodeHunt/index.php#team_Section">Team</a></li>
					<li> <a href="/CodeHunt/index.php#footer">About</a></li>
					<li> <a href="/CodeHunt/logout.php">LogOut</a></li>
					<li> <a href="/CodeHunt/profile.php" id="our-location" class="btn-success" ><?php echo $_SESSION['username']; ?></a></li>
				</ul>
    ...
    <h1 style="color:black; "><center>Welcome To Java Notes Section</center></h1>
</div>
    <?php 
              $con=mysqli_connect('localhost','root');
			  mysqli_select_db($con,'projectdatabase');
              $username=$_SESSION['username']; 
			$q="select * from videos where course_name='java' AND username='$username'";
			//echo $course_name;
